// src/components/dos-game-window/DosGameWindow.tsx
...
interface DosGameWindowProps {
  bundleUrl: string;
}

export const DosGameWindow: React.FC<DosGameWindowProps> = ({ bundleUrl }) => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      await dosRef.current.run(bundleUrl);
    };
